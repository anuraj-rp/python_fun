...
WINDOWHEIGHT = 480 #i pixels
REVEALSPEED = 8 #speed boxes' sliding reveals and covers
BOXSIZE = 40 # size of box height and width in pixels
GAPSIZE = 10 # number of columns of icons
...
assert len(ALLCOLORS) * len(ALLSHAPES) * 2 >= BOARDWIDTH * BOARDHEIGHT, \
    "Board is too big for the nubmer of shapes/colors defined"
...
def main():
    ...
    mousey = 0 #used to store y coordinate of the mouse event
    pygame.display.set_caption('Memeory Game')
    ...
    while True:
        ...
        if boxx != None and boxy != None:
            ...
            if not revealedBoxes[boxx][boxy]:#set the box as "revealed"
            ...
            if firstSelection == None:# the current box was the first box clicked"
                ...
                if icon1shape != icon2shape or icon1color != icon2color:
                    #icons don't match so cover up both the solutions
